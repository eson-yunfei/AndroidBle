...
public class ScanSettings implements Parcelable {
	...
	public static final class Builder {
		 ...
		 * and hardware does not support those types. In that case {@link BLEScannerCompat} starts a task that runs periodically and calls {@link ScanCallback#onScanResult(int, ScanResult)}
