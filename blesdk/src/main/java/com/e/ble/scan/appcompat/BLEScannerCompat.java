 ...
 * <p>
 * Use {@link BLEScannerCompat#getScanner()} to get an instance of the scanner.
 * <p>
...
public abstract class BLEScannerCompat {
	...
	public static BLEScannerCompat getScanner() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
			return mInstance = new ScannerCompat6X();
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
			return mInstance = new ScannerCompat5X();
		return mInstance = new ScannerCompat4X();
	}

	/* package */ BLEScannerCompat() {
